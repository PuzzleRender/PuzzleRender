...
import { puzzles } from "@/app/dashboard/page";
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    <div className="w-[31vw] min-h-screen border-r border-r-gray-300 flex items-start justify-start pt-6 flex-col space-y-3">
      <div className="w-full flex justify-between items-center font-medium text-xl px-3">
        <div className="flex w-full gap-2">
          ...
          <Select>
            <SelectTrigger className="w-2/3 border-none focus:ring-0 focus:border-none text-xl active:border-none">
        ...
        <FaRegBell className="font-bold text-2xl" />
      </div>
